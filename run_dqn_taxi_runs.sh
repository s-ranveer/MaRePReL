...
nohup python scripts/run_multiagent_dqn.py \
    ...
    --transfer True \
    --restore "logs/MultiAgentTaxi/IQL_DQN/DQN_rainbow_config_v2/2T3P/best_ep_rew_mean_checkpoint_003000" \
    --num-workers 2\
     > DQN_Taxi_Transfer_2T_3P_4P.log 2>&1 &

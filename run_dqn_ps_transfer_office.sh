...
nohup python scripts/run_multiagent_dqn_ps.py \
    ...
    --transfer True \
    --restore "logs/Done/MultiAgentOffice/PS_DQN/DQN_rainbow_config_v7/2A_Visit_Med_Bump/best_ep_rew_mean_checkpoint_003000/checkpoint_003000" \
    --num-workers 2 \
     > PS_Transfer_Office_2A_Get_med_bump.log 2>&1 &
